...
export class ReviewerReportsDetailComponent implements OnDestroy {
  ...
  constructor(private route: ActivatedRoute, private router: Router, private reviewerReportDataService: ReviewerReportDataService, private appUserDataService: AppUserDataService, private laboratoryDataService: LaboratoryDataService) {
    this.grades = [];
